...
console.log("Exercises 9–16 ready.");
...
btnEvenOdd.onclick = function () {
  ...
  if (Number.isNaN(n)) {
    evenOddOut.innerText = "Result: Invalid number";
  } else if (isEven(n)) {
...
btnCountdown.onclick = function () {
  ...
  if (Number.isNaN(start) || start < 0) {
    countdownOut.innerText = "Please enter a number 0 or greater.";
    return;
  }
...
btnSumN.onclick = function () {
  ...
  if (Number.isNaN(n) || n < 1) {
    sumNOut.innerText = "Sum: Invalid input";
    return;
  }
...
btnRepeat.onclick = function () {
  ...
  if (text.trim() === "" || Number.isNaN(times) || times < 1) {
    repeatOut.innerText = "Please enter text and a valid repeat count.";
    return;
  }
...
btnMinMax.onclick = function () {
  ...
  if (Number.isNaN(a) || Number.isNaN(b) || Number.isNaN(c)) {
    minMaxOut.innerText = "Please enter all 3 numbers.";
    return;
  }
...
btnTable.onclick = function () {
  ...
  if (Number.isNaN(n)) {
    tableOut.innerText = "Please enter a valid number.";
    return;
  }
